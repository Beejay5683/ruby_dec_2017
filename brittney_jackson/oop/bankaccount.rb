...
class BankAccount
    ...
    def total
        p "Checking Balance: #{@checking} | Saving Balance: #{@saving} | Total Balance: #{@checking + @saving}"
    end
...
staci = BankAccount.new
staci.account_number
staci.deposit('checking', 5000)
staci.deposit('saving', 5000)
staci.total